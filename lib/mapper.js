...
exports.page = function(page) {
  return pageAndScreen('[Segment Page View]', page);
};
...
exports.screen = function(screen) {
  return pageAndScreen('[Segment Screen View]', screen);
};

function pageAndScreen(evtName, pageOrScreen) {
  return {
    user_id: pageOrScreen.userId(),
    properties: pageOrScreen.properties(),
    event: evtName,
    timestamp: pageOrScreen.timestamp().getTime() / 1000
  };
}
